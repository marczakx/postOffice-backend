...
public class QueueServiceTests {
	...
	void testOrder() {
		...
		requests.add(new Request("r1", Priority.NORMAL, LocalDateTime.MIN));
		requests.add(new Request("r2", Priority.NORMAL, LocalDateTime.MIN.plusSeconds(2)));
		requests.add(new Request("r3", Priority.VIP, LocalDateTime.MIN.plusSeconds(3)));
		requests.add(new Request("r4", Priority.SUDDEN, LocalDateTime.MIN.plusSeconds(5)));
		requests.add(new Request("r5", Priority.VIP, LocalDateTime.MIN.plusSeconds(6)));
		requests.add(new Request("r6", Priority.SUDDEN, LocalDateTime.MIN.plusSeconds(7)));
		requests.add(new Request("r7", Priority.NORMAL, LocalDateTime.MIN.plusSeconds(500)));
		requests.add(new Request("r8", Priority.NORMAL, LocalDateTime.MIN.plusSeconds(501)));
		requests.add(new Request("r9", Priority.SUDDEN, LocalDateTime.MIN.plusSeconds(502)));
		requests.add(new Request("r10", Priority.VIP, LocalDateTime.MIN.plusSeconds(503)));
